        ...
        <div className ="everyThing">
            ...
            <div className="sideText">
                ...
                <div className="centerSquare">
                    <h1 id="message"><div className="text">Streaming<br/> just got<br/> a whole lot<br/></div>  easier </h1>
                    <p className="subHeading">Streaming to any platform<br/> from anywhere</p>
                </div>
